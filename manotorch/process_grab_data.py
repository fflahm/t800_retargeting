...
def load_grab_data(data_path=data_path, beta_path=beta_path, start_num=200, end_num=300):
    data_dict = np.load(data_path, allow_pickle=True)
    rhand = data_dict["rhand"].item()['params']
    human_rot_seq = rhand['global_orient'][start_num:end_num] # [N, 3]
    human_tran_seq = rhand['transl'][start_num:end_num] # [N, 3]
    ...
    object_rot_seq = object_data["global_orient"][start_num:end_num] # [N, 3]
